    ...
    <section className="About" id="about">
      ...
      <div className="About_content">
        <div className="About_data">
          <p>
            Hola! Mi nombre es Joan Mutti y disfruto creando cosas que ayuden a la gente a explorar el mundo digital. Mi interes hacia el mundo de la tecnologia nació cuando era pequeño y mis trabajos
            y pasiones siempre estuvieron dentro de este entorno.
          </p>
          <p>
